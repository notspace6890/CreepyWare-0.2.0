...
package dev.fxcte.creepyware.util.creepywareutils;
...
public class CreepyWareUtils implements Util
{
    ...
    public static void attackEntity(final Entity entity, final boolean packet, final boolean swingArm) {
        if (packet) {
            CreepyWareUtils.mc.field_71439_g.field_71174_a.func_147297_a((Packet)new CPacketUseEntity(entity));
        }
        else {
            CreepyWareUtils.mc.field_71442_b.func_78764_a((EntityPlayer)CreepyWareUtils.mc.field_71439_g, entity);
        }
        if (swingArm) {
            CreepyWareUtils.mc.field_71439_g.func_184609_a(EnumHand.MAIN_HAND);
        }
    }
    ...
    public static Vec3d getInterpolatedRenderPos(final Entity entity, final float partialTicks) {
        return getInterpolatedPos(entity, partialTicks).func_178786_a(CreepyWareUtils.mc.func_175598_ae().field_78725_b, CreepyWareUtils.mc.func_175598_ae().field_78726_c, CreepyWareUtils.mc.func_175598_ae().field_78723_d);
    }
    
    public static Vec3d getInterpolatedRenderPos(final Vec3d vec) {
        return new Vec3d(vec.field_72450_a, vec.field_72448_b, vec.field_72449_c).func_178786_a(CreepyWareUtils.mc.func_175598_ae().field_78725_b, CreepyWareUtils.mc.func_175598_ae().field_78726_c, CreepyWareUtils.mc.func_175598_ae().field_78723_d);
    }
    ...
    public static boolean stopSneaking(final boolean isSneaking) {
        if (isSneaking && CreepyWareUtils.mc.field_71439_g != null) {
            CreepyWareUtils.mc.field_71439_g.field_71174_a.func_147297_a((Packet)new CPacketEntityAction((Entity)CreepyWareUtils.mc.field_71439_g, CPacketEntityAction.Action.STOP_SNEAKING));
        }
        return false;
    }
    ...
    public static boolean isMobAggressive(final Entity entity) {
        if (entity instanceof EntityPigZombie) {
            ...
            if (entity instanceof EntityWolf) {
                return ((EntityWolf)entity).func_70919_bu() && !CreepyWareUtils.mc.field_71439_g.equals((Object)((EntityWolf)entity).func_70902_q());
            }
    ...
    public static List<Vec3d> getUnsafeBlocksFromVec3d(final Vec3d pos, final int height, final boolean floor) {
        ...
        for (final Vec3d vector : getOffsets(height, floor)) {
            ...
            final Block block = CreepyWareUtils.mc.field_71441_e.func_180495_p(targetPos).func_177230_c();
    ...
    public static boolean isObbyHole(final BlockPos blockPos) {
        ...
        for (final BlockPos pos : array) {
            final IBlockState touchingState = CreepyWareUtils.mc.field_71441_e.func_180495_p(pos);
    ...
    public static double getDst(final Vec3d vec) {
        return CreepyWareUtils.mc.field_71439_g.func_174791_d().func_72438_d(vec);
    }
    ...
    public static boolean isInWater(final Entity entity) {
        ...
        for (int x = MathHelper.func_76128_c(entity.field_70165_t); x < MathHelper.func_76143_f(entity.field_70165_t); ++x) {
            for (int z = MathHelper.func_76128_c(entity.field_70161_v); z < MathHelper.func_76143_f(entity.field_70161_v); ++z) {
                ...
                if (CreepyWareUtils.mc.field_71441_e.func_180495_p(pos).func_177230_c() instanceof BlockLiquid) {
                    return true;
                }
            }
        }
    ...
    public static boolean isDrivenByPlayer(final Entity entityIn) {
        return CreepyWareUtils.mc.field_71439_g != null && entityIn != null && entityIn.equals((Object)CreepyWareUtils.mc.field_71439_g.func_184187_bx());
    }
    ...
    public static List<Vec3d> targets(final Vec3d vec3d, final boolean antiScaffold, final boolean antiStep, final boolean legs, final boolean platform, final boolean antiDrop, final boolean raytrace) {
        final ArrayList<Vec3d> placeTargets = new ArrayList<Vec3d>();
        if (antiDrop) {
            Collections.addAll(placeTargets, BlockUtil.convertVec3ds(vec3d, CreepyWareUtils.antiDropOffsetList));
        }
        if (platform) {
            Collections.addAll(placeTargets, BlockUtil.convertVec3ds(vec3d, CreepyWareUtils.platformOffsetList));
        }
        if (legs) {
            Collections.addAll(placeTargets, BlockUtil.convertVec3ds(vec3d, CreepyWareUtils.legOffsetList));
        }
        Collections.addAll(placeTargets, BlockUtil.convertVec3ds(vec3d, CreepyWareUtils.OffsetList));
        if (antiStep) {
            Collections.addAll(placeTargets, BlockUtil.convertVec3ds(vec3d, CreepyWareUtils.antiStepOffsetList));
        }
        else {
            ...
            if (vec3ds.size() == 4) {
                for (final Vec3d vector : vec3ds) {
                    ...
                    if (antiScaffold) {
                        Collections.addAll(placeTargets, BlockUtil.convertVec3ds(vec3d, CreepyWareUtils.antiScaffoldOffsetList));
                    }
                    return placeTargets;
                }
            }
    ...
    public static boolean canEntityFeetBeSeen(final Entity entityIn) {
        return CreepyWareUtils.mc.field_71441_e.func_147447_a(new Vec3d(CreepyWareUtils.mc.field_71439_g.field_70165_t, CreepyWareUtils.mc.field_71439_g.field_70165_t + CreepyWareUtils.mc.field_71439_g.func_70047_e(), CreepyWareUtils.mc.field_71439_g.field_70161_v), new Vec3d(entityIn.field_70165_t, entityIn.field_70163_u, entityIn.field_70161_v), false, true, false) == null;
    }
    
    public static boolean isntValid(final Entity entity, final double range) {
        return entity == null || isDead(entity) || entity.equals((Object)CreepyWareUtils.mc.field_71439_g) || (entity instanceof EntityPlayer && CreepyWare.friendManager.isFriend(entity.func_70005_c_())) || CreepyWareUtils.mc.field_71439_g.func_70068_e(entity) > MathUtil.square(range);
    }
    ...
    public static double getMaxSpeed() {
        ...
        if (CreepyWareUtils.mc.field_71439_g.func_70644_a((Potion)Objects.requireNonNull(Potion.func_188412_a(1)))) {
            maxModifier *= 1.0 + 0.2 * (Objects.requireNonNull(CreepyWareUtils.mc.field_71439_g.func_70660_b((Potion)Objects.requireNonNull(Potion.func_188412_a(1)))).func_76458_c() + 1);
        }
        return maxModifier;
    }
    ...
    public static boolean isEntityMoving(final Entity entity) {
        ...
        if (entity instanceof EntityPlayer) {
            return CreepyWareUtils.mc.field_71474_y.field_74351_w.func_151470_d() || CreepyWareUtils.mc.field_71474_y.field_74368_y.func_151470_d() || CreepyWareUtils.mc.field_71474_y.field_74370_x.func_151470_d() || CreepyWareUtils.mc.field_71474_y.field_74366_z.func_151470_d();
        }
    ...
    public static void moveEntityStrafe(final double speed, final Entity entity) {
        if (entity != null) {
            final MovementInput movementInput = CreepyWareUtils.mc.field_71439_g.field_71158_b;
            double forward = movementInput.field_192832_b;
            double strafe = movementInput.field_78902_a;
            float yaw = CreepyWareUtils.mc.field_71439_g.field_70177_z;
    ...
    public static boolean rayTraceHitCheck(final Entity entity, final boolean shouldCheck) {
        return !shouldCheck || CreepyWareUtils.mc.field_71439_g.func_70685_l(entity);
    }
    ...
    public static boolean isMoving() {
        return CreepyWareUtils.mc.field_71439_g.field_191988_bg != 0.0 || CreepyWareUtils.mc.field_71439_g.field_70702_br != 0.0;
    }
    
    public static EntityPlayer getClosestEnemy(final double distance) {
        EntityPlayer closest = null;
        for (final EntityPlayer player : CreepyWareUtils.mc.field_71441_e.field_73010_i) {
            ...
            if (closest == null) {
                ...
                if (CreepyWareUtils.mc.field_71439_g.func_70068_e((Entity)player) >= CreepyWareUtils.mc.field_71439_g.func_70068_e((Entity)closest)) {
                    continue;
                }
                closest = player;
            }
    ...
    public static boolean checkCollide() {
        return !CreepyWareUtils.mc.field_71439_g.func_70093_af() && (CreepyWareUtils.mc.field_71439_g.func_184187_bx() == null || CreepyWareUtils.mc.field_71439_g.func_184187_bx().field_70143_R < 3.0f) && CreepyWareUtils.mc.field_71439_g.field_70143_R < 3.0f;
    }
    
    public static BlockPos getPlayerPosWithEntity() {
        return new BlockPos((CreepyWareUtils.mc.field_71439_g.func_184187_bx() != null) ? CreepyWareUtils.mc.field_71439_g.func_184187_bx().field_70165_t : CreepyWareUtils.mc.field_71439_g.field_70165_t, (CreepyWareUtils.mc.field_71439_g.func_184187_bx() != null) ? CreepyWareUtils.mc.field_71439_g.func_184187_bx().field_70163_u : CreepyWareUtils.mc.field_71439_g.field_70163_u, (CreepyWareUtils.mc.field_71439_g.func_184187_bx() != null) ? CreepyWareUtils.mc.field_71439_g.func_184187_bx().field_70161_v : CreepyWareUtils.mc.field_71439_g.field_70161_v);
    }
    
    public static double[] forward(final double speed) {
        float forward = CreepyWareUtils.mc.field_71439_g.field_71158_b.field_192832_b;
        float side = CreepyWareUtils.mc.field_71439_g.field_71158_b.field_78902_a;
        float yaw = CreepyWareUtils.mc.field_71439_g.field_70126_B + (CreepyWareUtils.mc.field_71439_g.field_70177_z - CreepyWareUtils.mc.field_71439_g.field_70126_B) * CreepyWareUtils.mc.func_184121_ak();
        if (forward != 0.0f) {
            if (side > 0.0f) {
    ...
    public static Map<String, Integer> getTextRadarPlayers() {
        ...
        for (final EntityPlayer player : CreepyWareUtils.mc.field_71441_e.field_73010_i) {
            if (!player.func_82150_aj()) {
                if (player.func_70005_c_().equals(CreepyWareUtils.mc.field_71439_g.func_70005_c_())) {
                    continue;
                }
                ...
                healthSB.append(hp);
                final int distanceInt = (int)CreepyWareUtils.mc.field_71439_g.func_70032_d((Entity)player);
                ...
                output.put(healthSB.toString() + " " + (CreepyWare.friendManager.isFriend(player) ? ChatFormatting.AQUA : ChatFormatting.RED) + player.func_70005_c_() + " " + distanceSB.toString() + " \u00c2§f0", (int)CreepyWareUtils.mc.field_71439_g.func_70032_d((Entity)player));
