...
public class EntityUtil implements Util
{
    ...
    public static boolean isObbyHole(final BlockPos blockPos) {
        ...
        final BlockPos[] array = array2 = (touchingBlocks = new BlockPos[] { blockPos.func_177978_c(), blockPos.func_177968_d(), blockPos.func_177974_f(), blockPos.func_177976_e(), blockPos.func_177977_b() });
    ...
    public static boolean isntValid(final Entity entity, final double range) {
        return entity == null || isDead(entity) || entity.equals((Object)EntityUtil.mc.field_71439_g) || (entity instanceof EntityPlayer && CreepyWare.friendManager.isFriend(entity.func_70005_c_())) || EntityUtil.mc.field_71439_g.func_70068_e(entity) > MathUtil.square(range);
    }
    ...
    public static Map<String, Integer> getTextRadarPlayers() {
        ...
        for (final EntityPlayer player : EntityUtil.mc.field_71441_e.field_73010_i) {
            ...
            output.put(healthSB.toString() + " " + (CreepyWare.friendManager.isFriend(player) ? "\u6402b" : "\u6402r") + player.func_70005_c_() + " " + distanceSB.toString() + " \u6402f" + CreepyWare.totemPopManager.getTotemPopString(player) + CreepyWare.potionManager.getTextRadarPotion(player), (int)EntityUtil.mc.field_71439_g.func_70032_d((Entity)player));
