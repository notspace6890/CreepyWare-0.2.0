...
public class PotionManager extends Feature
{
    ...
    public String getPotionString(final PotionEffect effect) {
        final Potion potion = effect.func_188419_a();
        return I18n.func_135052_a(potion.func_76393_a(), new Object[0]) + " " + ((!HUD.getInstance().potions1.getValue() && effect.func_76458_c() == 0) ? "" : (effect.func_76458_c() + 1 + " ")) + "§f" + Potion.func_188410_a(effect, 1.0f);
    }
